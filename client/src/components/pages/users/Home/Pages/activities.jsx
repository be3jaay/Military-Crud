...
const Activities = () => {
  ...
  return (
    <div className="bg-white flex h-full">
      ...
      <div className='bg-white h-full flex-grow p-7'>
        <header>
          <h1 className='text-4xl font-bold mb-3 '>🤖 Feeding Program</h1>
          <div className="flex items-center justify-start">
            <FaRegCalendarCheck className='text-lg' />
            <p className='text-gray-400 ml-2'>Date Started</p>
            <span className='bg-gray-500 text-white border p-2 ml-2 rounded-lg mr-3'>April 24 2024</span>
            <FaRegCalendarCheck className='text-lg' />
            <p className='text-gray-400 ml-2'>Due Date: </p>
            <span className='bg-gray-500 text-white border p-2 ml-2 rounded-lg'>April 24 2024</span>
          </div>
          <p className='text-lg text-black my-4'>Description :</p>
