    ...
    return(
        <div className="overflow-x-auto mt-12 shadow-md">
				...
				<thead className="ltr:text-left rtl:text-right">
					...
					<th className="whitespace-nowrap px-4 py-2 font-bold text-center  text-gray-900">Status</th>
					<th className="whitespace-nowrap px-4 py-2 font-bold text-center text-gray-900">Email Address</th>
					<th className="whitespace-nowrap px-4 py-2 font-bold  text-gray-900">Approval</th>
				...
				<tbody className="divide-y divide-gray-200">
					...
					<td className="px-4 py-6 ">
						...
						<td className="whitespace-nowrap px-4 py-2 text-center font-medium text-gray-900">Platoon</td>
