  ...
  return (
    <div className="flex h-screen">
      ...
      <div className='bg-white flex-grow p-7'>
		<h1 className='text-2xl font-bold text-center'>Administrator Profile</h1>
		...
		<span className='block text-xl'>Upload Profile Picture</span>
    <hr className='bg-black w-full my-2'/>
		...
		<button className="inline-block rounded bg-black w-full max-w-96 py-3 text-sm font-medium text-white transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:bg-indigo-500" href="#">Update</button>
		</div>
      </div>
    </div>
  )
